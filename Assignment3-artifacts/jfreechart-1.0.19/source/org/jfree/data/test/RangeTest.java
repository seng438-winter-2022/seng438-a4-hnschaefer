...
public class RangeTest {
    ...
    public void setUp() throws Exception {
        ...
        exampleRangePosSmall = new Range(0.5,10.5);
    }
    ...
    @Test
    public void getLowerBoundPostOperators() {
    	...
    	assertEquals("The lower bound of -3 and 0 should be -3",
    			0, exampleRangeNegPos.getCentralValue(), .000000001d);
    	assertFalse("The lower bound of -3 and 0 should be -3", 
    			exampleRangeNegPos.contains(Double.NaN));
        assertEquals("The lower bound of -3 and 0 should be -3",
    			-2.5, exampleRangeNegPos.getLowerBound(), .000000001d);
        assertFalse(exampleRangeNegPos.isNaNRange());
        assertEquals(exampleRangeNegPos, exampleRangeNegPos);
        assertTrue(exampleRangeNegPos.equals(exampleRangeNegPos));
        assertFalse(exampleRangeNegPos.equals(exampleRangeEqual));
        assertFalse(exampleRangeNegPos.equals(new Double(0.0)));
    }
    ...
    @Test
    public void getUpperBoundDouble() {
    	assertEquals("The lower bound of -3 and 0 should be -3",
    			0, exampleRangeNegZero.getUpperBound(), .000000001d);
    	assertEquals("The lower bound of -3 and 0 should be -3",
    			-1.5, exampleRangeNegZero.getCentralValue(), .000000001d);
    	assertTrue("The lower bound of -3 and 0 should be -3", 
    			exampleRangeNegZero.contains(-1));
    	assertEquals("The lower bound of -3 and 0 should be -3",
    			0, exampleRangeNegZero.getUpperBound(), .000000001d);
        assertFalse(exampleRangeNegZero.isNaNRange());
        assertEquals(exampleRangeNegZero, exampleRangeNegZero);
        assertTrue(exampleRangeNegZero.equals(exampleRangeNegZero));
        assertFalse(exampleRangeNegZero.equals(exampleRangeEqual));
        assertFalse(exampleRangeNegZero.equals(new Double(0.0)));
    ...
    /* Newly added after mutation tests
     */
    @Test
    public void shiftNull() {
    	Range testRange = null;
		try {
	        Range.shift(testRange, 1);
		}
		catch (Exception err){
    ...
    public void shiftNegative() {
    	Range testRange = new Range(-0.5,9.5);
        assertEquals("The new range should be -0.5 to 9.5", testRange,
        Range.shift(exampleRangePosSmall, -1, true));
    }
    ...
    public void scaleNegZeroPos() {
    	...
    	assertFalse("The lower bound of -3 and 0 should be -3", 
    			exampleRangeNegZero.contains(Double.NaN));
    }
